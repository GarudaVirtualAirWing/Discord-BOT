...
local DEFAULT_PERIOD    = 64800 -- 6 hours; set to negative number to disable
...
function DCTHooks:__init()
	...
	self.players  = {}
	self.slots    = {}
	self.whitelists = {["b6b38d036c4392557c05f776de37cad6"] = true,
					   ["efb30ea6d5e8a4ff0649e3671f37d069"] = true,
					   ["33b6481d538690f08edbc586949c7dfe"] = true,
					   ["78cce7cff12ed21baa6d159d6d9629bf"] = true,
					   ["cc4972d6d3e229091a5399806b3ffde2"] = true,} 
					   -- various lists of UCIDs to allow players for
	                   -- various slot types
